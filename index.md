...
<details class="project">
  <summary>Data Purpose Limitation<span class="venues"> (USENIX Security’24, NeurIPS’26)</span></summary>
  <a href="assets/img/catch11_demo.png" target="_blank">
    <img src="assets/img/catch11_demo.png" alt="Model-specific data authorization: recoding preserves authorized utility while degrading unauthorized models" style="width:100%; height:auto; display:block; border:1px solid rgba(140,140,140,0.25); border-radius:6px;">
  </a>
</details>

<details class="project">
  <summary>Model Usage Control<span class="venues"> (S&P’24, WWW’25, Euro S&P’26)</span></summary>
  <div style="border:1px solid rgba(140,140,140,0.25); border-radius:6px; background:rgba(140,140,140,0.04); padding:0.6rem;">
    <div style="display:grid; grid-template-columns:1fr 1.04fr 2.32fr; gap:0.6rem; align-items:center;">
      <img src="assets/img/animate2.gif" alt="Selective weight extraction from a trained network" style="width:100%; height:auto; display:block; border-radius:4px;">
      <img src="assets/img/sp24.gif" alt="Utility disparity between authorized and unauthorized models" style="width:100%; height:auto; display:block; border-radius:4px;">
      <img src="assets/img/sp_curve.png" alt="Proximity and disparity bounds among the original, degraded, and restored models" style="width:100%; height:auto; display:block; border-radius:4px;">
    </div>
  </div>
</details>

<details class="project">
  <summary>Neural Network Verification<span class="venues"> (OOPSLA’25)</span></summary>
  <a href="assets/img/wracct.png" target="_blank">
    <img src="assets/img/wracct.png" alt="Convex hull approximation for activation functions in neural network verification" style="width:100%; height:auto; display:block; border:1px solid rgba(140,140,140,0.25); border-radius:6px;">
  </a>
</details>
